...
> =
	...
	| ((
		s: {
			[S in keyof InsertColumnPropertySignatures<TTable>]: InsertColumnPropertySignatures<TTable>[S] extends
...
type CarryOverUndefined<From, To> = undefined extends From ? To | undefined
	: To;
...
> = Schema.Struct<
	...
	& {
		...
		& keyof TRefine
		& string
		]: InsertColumnPropertySignatures<TTable>[K] extends Schema.PropertySignature<
			any,
			any,
			any,
			any,
			any,
			any
		> ? TRefine[K] extends Schema.Schema<any, any, any> ? Schema.Schema<
			CarryOverOptionality<
				PropertySignatureType<InsertColumnPropertySignatures<TTable>[K]>,
				Schema.Schema.Type<TRefine[K]>
			>
		>
		: TRefine[K] extends (...a: any[]) => any ? PropertySignatureReplaceType<
...
> = Schema.Struct<
	...
	& {
		...
		& keyof TRefine
		& string
		]: SelectColumnPropertySignatures<TTable>[K] extends Schema.PropertySignature<
			any,
			any,
			any,
			any,
